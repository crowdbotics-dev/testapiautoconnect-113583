...
## Project Structure
    ...
    ├── testapiautoconnect_113583  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_113583`
...
2. Clone this repo and `cd testapiautoconnect_113583`
